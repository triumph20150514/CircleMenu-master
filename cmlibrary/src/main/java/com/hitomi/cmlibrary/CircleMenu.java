...
public class CircleMenu extends View {
    ...
    private void init() {
        ...
        Log.e("Trimph    circleRect", "top" + menuRectFs[0].top + " bottom" + menuRectFs[0].bottom + " left" + menuRectFs[0].left + " right" + menuRectFs[0].right);
        Log.e("Trimph", (menuRectFs[0].top) + "");
        Log.e("Trimph", partSize + "---------partSize");
    }
    ...
    private void drawSubMenu(Canvas canvas) {
        ...
        for (int i = 0; i < ITEM_NUM; i++) {
            ...
            if (status == STATUS_MENU_OPEN) {
                ...
                Log.e("Trimph", "toRadians sin" + Math.sin(Math.toRadians(angle)) + "fraction" + fraction);
                Log.e("Trimph", "toRadians cos" + Math.cos(Math.toRadians(angle)) + "fraction" + fraction);
            ...
            Log.e("Trimph", "clickIndex" + clickIndex);

            if (pressed && clickIndex - 1 == i) {
                Log.e("Trimph", "clickIndex  进来");
                //手指 按下改变按钮颜色
