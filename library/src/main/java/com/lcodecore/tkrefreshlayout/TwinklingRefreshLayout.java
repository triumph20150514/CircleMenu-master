...
public class TwinklingRefreshLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (mBottomLayout == null) {
            ...
            LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 20);
    ...
    GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            Log.e("Trimph", "velocityY" + mVelocityY);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (mChildView != null) {
                    if (state == PULL_DOWN_REFRESH) {
                        Log.e("Trimph", "childView" + mChildView.getTranslationY());
                        Log.e("Trimph", "childView mHeadHeight" + mHeadHeight);
                        if (!isPureScrollModeOn && mChildView.getTranslationY() >= mHeadHeight - mTouchSlop) { //下拉的距離大於 最大高度是
